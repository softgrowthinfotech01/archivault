...
<head>
    ...
    <title>Services | Windox | Window & Door Services HTML Template</title>
...
<body>
    ...
    <!-- Feature Section -->
    <div id="feature-1" class="feature-section section-padding pb-30">
        <div class="container">  
            ...
            <div class="row mt-30">
                <div class="col-xl-4 col-lg-4 col-md-4 text-center">
                    <div class="single-feature-item">
                        <div class="feature-icon">
                            <img src="assets/img/feature/feat-1.png" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 text-center">
                    <div class="single-feature-item">
                        <div class="feature-icon">
                            <img src="assets/img/feature/feat-2.png" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 text-center">
                    <div class="single-feature-item">
                        <div class="feature-icon">
                            <img src="assets/img/feature/feat-3.png" alt="">
                        </div>
